...
public class OnlineGameActivity extends AppCompatActivity {
    TextView tvPlayer1, tvPlayer2,tvPlayer3;
...
//                        tvPlayer1.setText(otherPlayer + "\'s turn");
    ...
    void ShowAlert(String Title) {
        ...
        b.setTitle(Title)
                .setMessage(Html.fromHtml("<font color='#FF7F27'>Start a new game?</font>"))
                .setCancelable(false)
                ...
                .setNegativeButton(Html.fromHtml("<font color='#FF7F27'>Menu</font>"), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
